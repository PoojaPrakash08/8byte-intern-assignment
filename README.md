...
* Public Application URL:
  The application is deployed on an AWS EC2 instance and is accessible via the following Elastic IP when the instance    is running: (http://13.53.183.148:3000/)
